...
clang -DBUILD_WASM=32 -std=c++20 -O3 -fno-builtin --target=wasm32 -c ../core/PD777Config.cpp -o ./obj/PD777Config.o
...
clang -Wl,--no-entry -Wl,--export-dynamic -Wl,--import-memory -fno-builtin -nostdlib --target=wasm32 -o ./html/wasm/uPD777.wasm ./obj/Decoder.o ./obj/Disassembler.o ./obj/KeyStatus.o ./obj/PD777.o ./obj/PD777Config.o ./obj/PD777Graphics.o ./obj/rom.o ./obj/romSetup.o ./obj/Stack.o ./obj/WasmPD777.o ./obj/clangSupport.o ./obj/catLowMemory.o ./obj/main.o
